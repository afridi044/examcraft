...
export function QuizTakingQuestionCard({
  ...
  return (
    ...
    >
      <Card className="bg-gray-800/50 border-gray-700/50 p-3 sm:p-4">
        <div className="space-y-3 sm:space-y-4">
          ...
          <div className="space-y-2 sm:space-y-3">
            ...
            <p className="text-sm sm:text-base text-gray-200 leading-normal">
              {question.content}
            </p>
          </div>
            ...
            {question.question_type === "fill-in-blank" ? (
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full p-2 sm:p-3 bg-gray-700/50 border border-gray-600 rounded-lg text-white placeholder:text-gray-400 min-h-[40px]"
                />
              </div>
            ) : (
